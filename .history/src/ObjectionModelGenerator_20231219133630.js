...
export default class ObjectionModelGenerator {
   ...
   * @param {*} modelNameBuilder
   */
  constructor(credentials = {}, dbName, dbKnexObjectPath, modelNameBuilder) {
    this.dbName = dbName;
  ...
  async createModels(prefix) {
    ...
    tables.forEach(async table => {
      ...
      if(this.modelNameBuilder) {
        modelName = this.modelNameBuilder(modelName);
      }
      let constrains = [];
      let requireds = [];
      let searches = [];
